        ...
        <Card className="w-full max-w-2xl mx-auto backdrop-blur-sm bg-white/90 border-0 shadow-2xl rounded-3xl">
          <CardContent className="p-8 text-center space-y-6">
           ...
           <div className="space-y-4">
              <Button 
                size="lg" 
                className="w-full bg-green-600 hover:bg-green-700 text-white py-5 text-lg rounded-2xl flex flex-col md:flex-row items-center gap-2"
